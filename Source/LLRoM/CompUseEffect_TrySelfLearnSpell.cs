    ...
    public class CompUseEffect_TrySelfLearnSpell : CompUseEffect
    {
        ...
        public override void DoEffect(Pawn usedBy)
        {
            ...
            for (int i = 0; i < compAbilityUserMagic.MagicData.AllMagicPowers.Count; i++)
            {
                ...
                if (possibleAbilities.Contains(tMAbilityDef.learnItem) && compAbilityUserMagic.MagicData.AllMagicPowers[i].learned == true)
                {
                    possibleAbilities.Remove(tMAbilityDef.learnItem);
                }
                if (possibleAbilities.Contains(tMAbilityDef.learnItem) && compAbilityUserMagic.customClass != null && !compAbilityUserMagic.customClass.learnableSpells.Contains(tMAbilityDef.learnItem))
                {
                    possibleAbilities.Remove(tMAbilityDef.learnItem);
                }
            }
        ...
        private bool LearnableCheck(Pawn p, ThingDef S)
        {
            ...
            if ((S.defName == "SpellOf_DryGround" || S.defName == "SpellOf_Firestorm" || S.defName == "SpellOf_HeatShield" || S.defName == "SpellOf_CauterizeWound") && !traitdefs.Contains(TorannMagicDefOf.InnerFire))
            {
                return false;
            }
            if ((S.defName == "SpellOf_Blizzard" || S.defName == "SpellOf_WetGround") && !traitdefs.Contains(TorannMagicDefOf.HeartOfFrost))
            {
                return false;
            }
            if ((S.defName == "SpellOf_ChargeBattery" || S.defName == "SpellOf_EyeOfTheStorm") && !traitdefs.Contains(TorannMagicDefOf.StormBorn))
            {
                return false;
            }
            if ((S.defName == "SpellOf_FoldReality") && !traitdefs.Contains(TorannMagicDefOf.Arcanist))
            {
                return false;
            }
            if ((S.defName == "SpellOf_Resurrection") && !traitdefs.Contains(TorannMagicDefOf.Priest))
            {
                return false;
            }
            if ((S.defName == "SpellOf_BattleHymn") && !traitdefs.Contains(TorannMagicDefOf.TM_Bard))
            {
                return false;
            }
            if ((S.defName == "SpellOf_HolyWrath") && !traitdefs.Contains(TorannMagicDefOf.Paladin))
            {
                return false;
            }
            if ((S.defName == "SpellOf_LichForm") && !traitdefs.Contains(TorannMagicDefOf.Necromancer))
            {
                return false;
            }
            if ((S.defName == "SpellOf_SummonPoppi") && !traitdefs.Contains(TorannMagicDefOf.Summoner))
            {
                return false;
            }
            if ((S.defName == "SpellOf_Scorn") && !traitdefs.Contains(TorannMagicDefOf.Succubus))
            {
                return false;
            }
            if ((S.defName == "SpellOf_PsychicShock") && !traitdefs.Contains(TorannMagicDefOf.Warlock))
            {
                return false;
            }
            if ((S.defName == "SpellOf_Meteor") && !traitdefs.Contains(TorannMagicDefOf.Geomancer))
            {
                return false;
            }
            if ((S.defName == "SpellOf_Recall") && !traitdefs.Contains(TorannMagicDefOf.Chronomancer))
            {
                return false;
            }
            if ((S.defName == "SpellOf_RegrowLimb" || S.defName == "SpellOf_BriarPatch" || S.defName == "SpellOf_FertileLands") && !traitdefs.Contains(TorannMagicDefOf.Druid))
            {
                return false;
            }
            if ((S.defName == "SpellOf_OrbitalStrike" || S.defName == "SpellOf_MechaniteReprogramming" || S.defName == "SpellOf_Overdrive" || S.defName == "SpellOf_Sabotage" || S.defName == "SpellOf_TechnoShield") && !traitdefs.Contains(TorannMagicDefOf.Technomancer))
            {
                return false;
            }
            if ((S.defName == "SpellOf_BlankMind" || S.defName == "SpellOf_Shapeshift") && !traitdefs.Contains(TorannMagicDefOf.Enchanter))
            {
                return false;
            }
            if ((S.defName == "SpellOf_BloodMoon") && !traitdefs.Contains(TorannMagicDefOf.BloodMage))
            {
                return false;
            }
            if ((S.defName == "SpellOf_LightningTrap" || S.defName == "spell_ArcaneBolt") && p.story.DisabledWorkTagsBackstoryAndTraits != WorkTags.Violent)
            {
                return false;
            }
            return true;
